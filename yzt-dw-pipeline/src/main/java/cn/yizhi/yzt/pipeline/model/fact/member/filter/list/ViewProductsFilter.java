 ...
 * <p>
 * 受上方行为发生时间影响
 * 浏览商品指浏览过该商品详情的行为，默认为空，则代表不对该项进行筛选，如果设置为全部，则代表只要浏览过任意一个商品都算
...
@Getter
@Setter
public class ViewProductsFilter extends Filter<FactMemberProductLog> {
    ...
    public ViewProductsFilter(FilterDefinition definition) {
        super(definition);
    }
